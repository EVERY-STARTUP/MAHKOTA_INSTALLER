...
const reportSchema_1 = require("../../schemas/reportSchema"); // Import findOneReport schema
const logger_1 = __importDefault(require("../../utilities/logger"));
const findOne = async (req, res) => {
    // Validasi request parameters untuk reportId
    const { error, value } = (0, validateRequest_1.validateRequest)(reportSchema_1.findOneReportSchema, req.params);
    if (error) {
    ...
    try {
        ...
        // Mengirimkan response sukses jika report ditemukan
        const response = response_1.ResponseData.success(result);
        logger_1.default.info('Report found successfully');
